...
export const EFFECT_PARAM_REGISTRY: Record<string, ParamRegistryEntry> = {
  ...
  feedback: {
    getParams: () => [
      ...
      { id: 'zoom', label: 'ZOOM', min: 0.5, max: 2.0, step: 0.01,
      ...
      { id: 'offsetX', label: 'OF.X', min: -0.3, max: 0.3, step: 0.001,
        apply: (v) => g().updateFeedbackLoop({ offsetX: v }), read: () => g().feedbackLoop.offsetX },
      { id: 'offsetY', label: 'OF.Y', min: -0.3, max: 0.3, step: 0.001,
        apply: (v) => g().updateFeedbackLoop({ offsetY: v }), read: () => g().feedbackLoop.offsetY },
      { id: 'rotation', label: 'ROT', min: -180, max: 180, step: 1,
  ...
  echo_trail: {
    getParams: () => [
      ...
      { id: 'trailCount', label: 'CNT', min: 2, max: 32, step: 1,
        apply: (v) => mot().updateEchoTrail({ trailCount: v }), read: () => mot().echoTrail.trailCount },
